# IW8-Launcher
This app uses Electron. HTML & JS. App will be updated over time with quality of life changes.

Make sure to launch game with "Launch" button to open 'ModernWarfare.exe' and if wanting to launch 1.20 LAN (Yes you can use it with IW8-Mod, More info how to use LAN in 1.20 below).
